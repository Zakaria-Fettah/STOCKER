            ...
            <div class="card shadow-lg">
                <div class="card-header bg-primary text-white">
                    <div class="d-flex justify-content-between align-items-center">
                        <h2 class="h4 mb-0"><i class="fas fa-cube me-2"></i>Ajouter un nouveau produit</h2>
                    ...
                    <form action="{{ route('products.store') }}" method="POST" class="needs-validation" novalidate>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="idcategories" class="form-select" required>
                                    ...
                                    @foreach ($categories as $cat)
                                        <option value="{{ $cat->id }}" {{ old('idcategories') == $cat->id ? 'selected' : '' }}>
                                            {{ $cat->nomCategorie }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <i class="fas fa-money-bill-wave me-1"></i> Prix (MAD) <span class="text-danger">*</span>
                                </label>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="quantite" class="form-control" 
                                       value="{{ old('quantite') }}" required min="0">
                                <div class="invalid-feedback">
