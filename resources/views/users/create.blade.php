            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        {!! Form::email('email', null, ['placeholder' => 'Entrer l\'adresse email', 'class' => 'form-control', 'id' => 'email', 'required']) !!}
                        <div class="invalid-feedback">
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        {!! Form::select('roles[]', $roles, [], ['class' => 'form-select', 'multiple', 'id' => 'roles', 'required']) !!}
                        <div class="invalid-feedback">
